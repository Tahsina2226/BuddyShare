...
interface EventSidebarProps {
  ...
  setUserReview: (review: { rating: number; comment: string; _id?: string }) => void;
    ...
    <div className="space-y-6">
        ...
        <div className="space-y-4">
          {isUserHost ? (
            ...
            <button
              onClick={onJoinEvent}
              disabled={
                joining || (canJoinInfo && !canJoinInfo.canJoin)
              }
      ...
      >
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="mb-2 text-white/60 text-sm">
              {event.host.bio || "Professional Event Organizer"}
            </p>
            ...
            {event.host.averageRating && event.host.averageRating > 0 ? (
              <div className="flex items-center">
                ...
                <span className={`ml-2 font-bold ${getRatingColor(event.host.averageRating)}`}>
        ...
        <div className="gap-2 grid grid-cols-2">
          ...
          {user && isUserParticipant && !isUserHost && (
            <button
      ...
      <AnimatePresence>
        {showReviewForm && (
          <motion.div
            ...
            className="bg-gradient-to-br from-[#234C6A]/50 via-[#1a3d57]/40 to-[#152a3d]/30 shadow-2xl backdrop-blur-xl p-8 border-2 border-white/25 rounded-2xl overflow-hidden"
          >
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center gap-3">
                <div className="bg-gradient-to-br from-[#96A78D] to-[#889c7e] shadow-lg p-2 rounded-lg">
